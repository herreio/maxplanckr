...
from ..utils.paths import LOG_DIR, MAPPED_DIR, OUS_DIR, GRAPH_DIR
...
def routine():
    ...
    utils.write_csv(os.path.join(
        GRAPH_DIR, "mpis--ous_nodes--tree-full.csv"), ous_nodes)
    utils.write_csv(os.path.join(
        GRAPH_DIR, "mpis--ous_ous_edges--tree.csv"), ous_edges)
    ...
    utils.write_csv(os.path.join(
        GRAPH_DIR, 'mpis--ous_nodes--tree-children.csv'), kids_names)
